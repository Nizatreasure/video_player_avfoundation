...
class PipMessage {
  ...
  Object encode() {
    final Map<Object?, Object?> pigeonMap = <Object?, Object?>{};
    pigeonMap['textureId'] = textureId;
    pigeonMap['isPip'] = isPip;
    return pigeonMap;
  }

  static PipMessage decode(Object message) {
    final Map<Object?, Object?> pigeonMap = message as Map<Object?, Object?>;
    return PipMessage(
      textureId: pigeonMap['textureId']! as int,
      isPip: pigeonMap['isPip']! as bool,
    );
  }
}
...
class _AVFoundationVideoPlayerApiCodec extends StandardMessageCodec {
  ...
  Object? readValueOfType(int type, ReadBuffer buffer) {
    switch (type) {
      ...
      case 130:
        return PipMessage.decode(readValue(buffer)!);
...
class AVFoundationVideoPlayerApi {
  ...
  Future<void> setPip(PipMessage arg_msg) async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.AVFoundationVideoPlayerApi.togglePictureInPictureMode',
        codec,
        binaryMessenger: _binaryMessenger);
    final Map<Object?, Object?>? replyMap =
        await channel.send(<Object?>[arg_msg]) as Map<Object?, Object?>?;
