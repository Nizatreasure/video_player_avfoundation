...
@interface FLTPipModeMessage : NSObject
/// `init` unavailable to enforce nonnull fields, see the `make` class method.
- (instancetype)init NS_UNAVAILABLE;
+ (instancetype)makeWithTextureId:(NSNumber *)textureId isPip:(NSNumber *)isPip;
@property(nonatomic, strong) NSNumber *textureId;
@property(nonatomic, strong) NSNumber *isPip;
@end
...
- (void)togglePictureInPictureMode:(FLTPipModeMessage *)msg error:(FlutterError *_Nullable*_Nonnull)error;
